            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#cart"><?=$_SESSION['username']?>'s Cart</a></li>
                        <?php
                            if($_SESSION['role']=="A"){
                                
                                echo "<li class='nav-item'><a class='nav-link js-scroll-trigger' href='addItem.php'>Add Items</a></li>";
        ...
        <section class="page-section" id="shopping">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">UNISEX's category</h3>
