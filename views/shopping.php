    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                Ren's Store<i class="fab fa-canadian-maple-leaf fa-2x"></i>
                </a>
                    ...
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <?php
                            if($_SESSION['role']=="A"){
                                ...
                                echo "<li class='nav-item'><a class='nav-link js-scroll-trigger' href='addItem.php'>Add</a></li>";
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="container text-center mb-5">
                        ...
                        <a href="shopWomen.php#shopping" class="text-dark mx-2 section-heading text-uppercase h5">WOMEN</a>
                        <a href="shopUnisex.php#shopping" class="text-dark mx-2 section-heading text-uppercase h5">UNISEX</a> -->
                        <form action="#shopping" method="post">
                            <div class="mx-auto text-center">
                                    <input type="submit" value="ALL" name="all"  class="text-bark bg-white border border-0">
                                    <input type="submit" value="MEN" name="men"  class="bg-white border border-0">
                                    <input type="submit" value="WOMEN" name="women"  class="bg-white border border-0">
                                    <input type="submit" value="UNISEX" name="unisex"  class="bg-white border border-0">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                if($row['s_quantity'] == 0 && $row['m_quantity'] == 0 && $row['l_quantity'] == 0){
                                    echo "<p class='text-danger mt-4 h2'>SOLD OUT!</p>";
                                }else{
                                    $a = $row['price'];
                                    $b = $row['gender'];
                                    echo "<h5>$$a</h5>";
                            ...
                            <!-- <h5>Stocks:</h5>
                            <h5>S:<?//$row['s_quantity']?></h5>
                            <h5>M:<?//$row['m_quantity']?></h5>
                            <h5>L:<?//$row['l_quantity']?></h5> -->
        ...
        <section class="page-section block-inline bg-light" id="cart">
            <div class="container">
                <div class="text-center">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <?php
                        $result = $user->getOrders($_SESSION['id']);
                        $sum=0;
                        if($result){
        ...
        <section class="page-section" id="access">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">My store is in here.</h3>
                </div>
                <div class="text-center">
                <div class="ggmap"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.680495926725!2d139.72788801516546!3d35.6602427387303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188b771049dc33%3A0x5bfe0248594cc802!2z5YWt5pys5pyo44OS44Or44K6!5e0!3m2!1sja!2sjp!4v1600331867862!5m2!1sja!2sjp" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
                </div>
        ...
        <!-- Portfolio Grid-->
        <!-- <section class="page-section block-inline bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
        ...
        <!-- Team-->
        <!-- <section class="page-section block-inline bg-light" id="team">
            <div class="container">
                <div class="text-center">
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">You can send me any notice and question.</h3>
                </div>
